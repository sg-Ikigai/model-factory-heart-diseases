...
Download `heart.csv` from [`ineubytes/heart-disease-dataset`](https://www.kaggle.com/datasets/ineubytes/heart-disease-dataset) and place it at `data/heart.csv`. The notebook will skip the download step automatically.
